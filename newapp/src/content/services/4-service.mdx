...
seoAriaLabel: "Get expert Technology Consulting to reduce costs, improve performance, and navigate digital transformation"
---
...
<section>
    ...
    <section class="section3 relative section-bg">
        ...
        <div class="container py-10 md:py-40">
          ...
          <ServiceCard collectionName="corefeaturesTechnologyConsulting"/>
        </div>
    </section>
