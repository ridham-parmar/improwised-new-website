...
seoAriaLabel: "Discover Product Modernization services including cloud migration, technology upgrades, and legacy system transformation"
---
...
<section>
    ...
    <section class="section3 relative section-bg">
        ...
        <div class="container py-10 md:py-40">
          ...
          <ServiceCard collectionName="corefeaturesProductModernization"/>
        </div>
    </section>
