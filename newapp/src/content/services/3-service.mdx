...
import pm from "$lib/images/services/pm.svg"
import pm3 from "$lib/images/services/pm3.svg"
...
<section>
    <section class="section1 flex flex-col gap-10 pt-30 pb-20 md:pt-60 md:pb-[240px] bg-platform">
        ...
        <div class="container flex justify-center">
          <Image class="hidden md:block" alt="building block" width={1200} src={pm3}/>
          {/* <Image class="hidden md:block" alt="building block" width={1200} src={pm1}/> */}
