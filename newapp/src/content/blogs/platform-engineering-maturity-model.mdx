...
<div class="blog-details">
  ...
  <div class="overflow-x-hidden">
      <h2 id="Level 1: Ad-Hoc and Manual Execution" class="scroll-mt-[8rem] lg:scroll-mt-28">Level 1: Ad-Hoc and Manual Execution</h2>
      <Image
        src={blogImageInner}
        alt="hero Image"
        class="w-auto py-20"
      ...
      <h3 id="Level 2: Standardized Foundations" class="scroll-mt-[8rem] lg:scroll-mt-28">Level 2: Standardized Foundations</h3>
      ...
      <h2 id="Level 3: Automated Delivery Pipelines" class="scroll-mt-[8rem] lg:scroll-mt-28">Level 3: Automated Delivery Pipelines</h2>
      ...
      <h3 id="Level 4: Self-Service Platforms" class="scroll-mt-[8rem] lg:scroll-mt-28">Level 4: Self-Service Platforms</h3>
      ...
      <h3 id="Level 5: Continuous Evolution" class="scroll-mt-[8rem] lg:scroll-mt-28">Level 5: Continuous Evolution</h3>
      ...
      <h3 id="Assessing Organizational Maturity" class="scroll-mt-[8rem] lg:scroll-mt-28">Assessing Organizational Maturity</h3>
      ...
      <h3 id="Consequences of Maturity Stagnation" class="scroll-mt-[8rem] lg:scroll-mt-28">Consequences of Maturity Stagnation</h3>
      ...
      <h3 id="Interconnected Aspects of Maturity" class="scroll-mt-[8rem] lg:scroll-mt-28">Interconnected Aspects of Maturity</h3>
      ...
      <h3 id="Implementing the Model" class="scroll-mt-[8rem] lg:scroll-mt-28">Implementing the Model</h3>
      ...
      <h4 id="Conclusion" class="scroll-mt-[8rem] lg:scroll-mt-28">Conclusion</h4>
