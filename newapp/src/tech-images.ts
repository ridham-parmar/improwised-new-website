...
export const level1 = [
    ...
    { name: "Linux", url: linux, alt: "Linux", link: "https://www.linux.org/" },
]

export const level2 = [
    { name: "Kubernetes", url: kubernetes, alt: "Kubernetes", link: "https://kubernetes.io/" },
    { name: "Circle CI", url: circlci, alt: "Circle CI", link: "https://circleci.com/" },
...
export const level3 = [
    { name: "React", url: react, alt: "React", link: "https://react.dev/" },
    { name: "Vue", url: vue, alt: "Vue", link: "https://vuejs.org/" },
    { name: "AWS", url: aws, alt: "AWS", link: "https://aws.amazon.com/getting-started/?nc2=h_ls" },
    { name: "Angular", url: angular, alt: "Angular", link: "https://angularjs.org/" },
    { name: "Dexidp", url: dexidp, alt: "Dexidp", link: "https://dexidp.io/" },
    { name: "ArgoCD", url: argo, alt: "ArgoCD", link: "https://argoproj.github.io/cd/" },
    { name: "NodeJs", url: node, alt: "NodeJs", link: "https://nodejs.org/en" },
...
export const level4 = [
    ...
    { name: "Uptime Kuma", url: uptimekuma, alt: "Uptime Kuma", link: "https://uptime.kuma.pet/" },
    { name: "Forgejo", url: forgejo, alt: "Forgejo", link: "https://forgejo.org/" },
    { name: "Traefik", url: traefik, alt: "Traefik", link: "https://traefik.io/traefik/" },
    { name: "EMQX", url: emqx, alt: "EMQX", link: "https://www.emqx.io/" },
    { name: "Apache", url: apache, alt: "Apache", link: "https://httpd.apache.org/" },
    { name: "Concourse CI", url: concourse, alt: "Concourse CI", link: "https://concourse-ci.org/" },
    { name: "Authentik", url: authentik, alt: "Authentik", link: "https://github.com/goauthentik/authentik" },
    { name: "Drone CI", url: drone, alt: "Drone CI", link: "https://www.drone.io/" },
    ...
    { name: "Puppet", url: puppet, alt: "Puppet", link: "https://www.puppet.com/" },
    { name: "Progress Chef", url: progresschef, alt: "Progress Chef", link: "https://www.chef.io/" },
]